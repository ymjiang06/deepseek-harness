...
flowchart LR
  ...
  plugin_dsh_base_web_search_oneapi["web-search-oneapi<br/>@deepseek-ai/dsh-web-search-oneapi"]
  cfg --> plugin_dsh_base_web_search_oneapi
...
| `web-search-oneapi` | `@deepseek-ai/dsh-web-search-oneapi` |
